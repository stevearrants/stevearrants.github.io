...
<div style="border-left:4px solid #2D6A4F; padding:1.25rem 1.5rem; background:#fff; border-radius:0 6px 6px 0; box-shadow:0 2px 8px rgba(0,0,0,0.05); margin-bottom:1.5rem;">
  <div style="display:flex; justify-content:space-between; align-items:baseline; flex-wrap:wrap;">
    <h3 style="font-size:1.05rem; margin:0 0 0.15rem;">Technical Writer (Expert)</h3>
    <span style="font-size:0.85rem; color:#777;">2021 – 2024</span>
  </div>
  <p style="font-size:0.9rem; color:#2D6A4F; margin:0 0 0.75rem; font-weight:600;">Agilent Technologies, Inc. &nbsp;·&nbsp; Winooski, Vermont</p>
  <p style="font-size:0.9rem; color:#555; margin-bottom:0.75rem;">Global leader in life sciences and diagnostics with $6B+ revenue. Developed technical documentation for 15+ hardware and software products.</p>
  <ul style="font-size:0.9rem; color:#555; margin:0; padding-left:1.2rem;">
...
<div style="border-left:4px solid #2D6A4F; padding:1.25rem 1.5rem; background:#fff; border-radius:0 6px 6px 0; box-shadow:0 2px 8px rgba(0,0,0,0.05); margin-bottom:1.5rem;">
  <div style="display:flex; justify-content:space-between; align-items:baseline; flex-wrap:wrap;">
    <h3 style="font-size:1.05rem; margin:0 0 0.15rem;">Senior Content Developer</h3>
    <span style="font-size:0.85rem; color:#777;">2019 – 2021</span>
  </div>
  <p style="font-size:0.9rem; color:#2D6A4F; margin:0 0 0.75rem; font-weight:600;">Jitterbit &nbsp;·&nbsp; Alameda, California</p>
  <p style="font-size:0.9rem; color:#555; margin-bottom:0.75rem;">B2B SaaS/iPaaS cloud integration platform. Created API documentation and system integration guides for a complex data integration platform.</p>
  <ul style="font-size:0.9rem; color:#555; margin:0; padding-left:1.2rem;">
    <li>Reduced support ticket volume by 40% through strategic improvements to user guides and release notes.</li>
    <li>Established Agile documentation methodologies using Confluence and docs-as-code approaches.</li>
    <li>Developed documentation for data connectors and ETL processes serving both technical and business users.</li>
  </ul>
</div>
 
*Full work history available in the downloadable resume.*
