...
Work with the other writers to develop rules specific to your audience. Then, pick a recognized style guide. The [Chicago Manual of Style](https://www.chicagomanualofstyle.org/home.html) is good for general grammar and usage. [Apple](https://support.apple.com/guide/applestyleguide/welcome/web), [Microsoft](https://learn.microsoft.com/en-us/style-guide/welcome/), or [Google style](https://developers.google.com/style) guides are also good choices. Pick one and stick with it.
...
Once you have a plan and schedule, you can refer to it when asked where you are and your status.
