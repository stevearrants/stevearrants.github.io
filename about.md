...
layout: page
title: About Steve
subtitle: Over thirty years of making complex things clear
---
 
Over thirty years ago I started my career writing user guides for software that nobody thought needed explaining. I quickly learned that the gap between what engineers build and what users understand isn't a writing problem — it's a thinking problem. My job ever since has been to close that gap: understand how something works, understand what users actually need to know, and connect the two in the simplest, most durable way possible.
