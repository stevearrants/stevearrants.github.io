...
I was among approximately 15% of Agilent's employees laid off this summer, so I'm back in the job market! 
Even if we're not a match, I may be able to recommend some folks to you.
...
I use Madcap Flare, Markdown, and Docs As Code workflows for online documentation. Camtasia videos are a great tool for training. 
I also use Microsoft Office, Git, and Visual Studio Code.
This website is built with Jekyll and MKDocs.  
...
Do you want me to know if you have spent more than three seconds on this page, which nearly all recruiters do? In your email, mention _the serial comma_, and you will have my attention and gratitude. 
